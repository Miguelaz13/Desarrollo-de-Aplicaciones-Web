      ...
      <div id="columna2">
            ...
            <form>
				<?php //query.php
					...
					echo "<td bgcolor='4A84EF'><font color='black'><b>Grado</b></font></td>";
					echo "<td bgcolor='4A84EF'><font color='black'><b>Seccion</b></font></td>";
					...
					{	
						...
						echo '<td> ' . mysql_result($result,$j,'grado') . '</td>';
						echo '<td> ' . mysql_result($result,$j,'seccion') . '</td>';
